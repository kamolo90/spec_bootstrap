...
#   end
  ...
  #   Capybara::Poltergeist::Driver.new(app, :timeout => 60, :phantomjs_options => ['--proxy-type=socks5', '--proxy=0.0.0.0:0', '--ignore-ssl-errors=yes'])
  # end
  ...
  #     :debug => false,
  #     :window_size => [1280, 1600],
  #     :phantomjs_options => ['--load-images=yes', '--ssl-protocol=ANY', '--disk-cache=false'],
  #     :inspector => true,
